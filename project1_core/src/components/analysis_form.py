...
from project1_core.src.services.ai_service import generate_analysis
from project1_core.src.config.prompts import SPECIALIST_PROMPTS
from project1_core.src.utils.pdf_extractor import extract_text_from_pdf
from project1_core.src.config.sample_data import SAMPLE_REPORT
from project1_core.src.config.app_config import MAX_UPLOAD_SIZE_MB
