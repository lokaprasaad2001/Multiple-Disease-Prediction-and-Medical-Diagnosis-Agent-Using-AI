...
from project1_core.src.config.app_config import APP_ICON, APP_NAME, APP_TAGLINE, APP_DESCRIPTION
from project1_core.src.utils.validators import validate_signup_fields
import time
import re
